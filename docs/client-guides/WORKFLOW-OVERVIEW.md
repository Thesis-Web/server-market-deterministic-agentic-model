...
Example: _"Based on my experience, I know that the biggest pain point for
our customers is actually X, not Y. Please factor that in."_
...
_"I'm stuck. Here is what I was trying to do: [describe it].
